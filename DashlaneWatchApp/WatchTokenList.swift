...
extension WatchApplicationContext.Token {
  static var mockGoogle: Self {
    .init(
      url: .init(
        string:
          "otpauth://totp/google%3Atest?secret=7IQI3XLXFILVRFHN7DXNMKLHG7FWZEY3TVUDSPUITUZRSMPRPQQCIKUNTQHU3GAKHSGYCE4YU5U7AGYIT6FSLIDKLAWGVAEB5ESGFWY&issuer=google"
      )!, title: "Google")
  }
}

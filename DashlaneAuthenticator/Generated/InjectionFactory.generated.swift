...
extension AuthenticatorMockContainer {
  ...
  internal func makeAddItemFlowViewModel(
    hasAtLeastOneTokenStoredInVault: Bool, mode: AddItemMode, skipIntro: Bool = false,
...
extension AuthenticatorMockContainer {
  @MainActor
  internal func makeAddItemManuallyFlowViewModel(
    mode: AddItemMode, isFirstToken: Bool,
...
extension AuthenticatorMockContainer {
  @MainActor
  internal func makeAddItemScanCodeFlowViewModel(
    otpInfo: OTPInfo? = nil, mode: AddItemMode, isFirstToken: Bool,
    didCreate: @escaping (OTPInfo, Definition.OtpAdditionMode) -> Void
...
extension AuthenticatorMockContainer {
  ...
  public func makeAddLoginDetailsViewModel(
...
extension AuthenticatorMockContainer {
  ...
  public func makeChooseWebsiteViewModel(completion: @escaping (String) -> Void)
...
extension AuthenticatorMockContainer {
  ...
  internal func makeTokenRowViewModel(token: OTPInfo, dashlaneTokenCaption: String = "")
    -> TokenRowViewModel
  {
...
extension AuthenticatorServicesContainer {
  ...
  internal func makeDownloadDashlaneViewModel(
    showAppStorePage: @escaping (AppStoreProductViewer) -> Void
...
extension AuthenticatorServicesContainer {
  ...
  internal func makeUnlockViewModel(
    login: Login, authenticationMode: AuthenticationMode, loginOTPOption: ThirdPartyOTPOption?,
...
extension InjectedFactory where T == _AddItemManuallyFlowViewModelFactory {
  @MainActor
  func make(
    mode: AddItemMode, isFirstToken: Bool,
    didCreate: @escaping (OTPInfo, Definition.OtpAdditionMode) -> Void
...
extension InjectedFactory where T == _AddItemScanCodeFlowViewModelFactory {
  @MainActor
  func make(
    otpInfo: OTPInfo? = nil, mode: AddItemMode, isFirstToken: Bool,
    didCreate: @escaping (OTPInfo, Definition.OtpAdditionMode) -> Void
...
extension InjectedFactory where T == _CredentialRowViewModelFactory {
...
extension InjectedFactory where T == _DownloadDashlaneViewModelFactory {

  func make(showAppStorePage: @escaping (AppStoreProductViewer) -> Void)
    -> DownloadDashlaneViewModel
  {
    return factory(
      showAppStorePage
...
extension InjectedFactory where T == _TokenListViewModelFactory {
...
extension InjectedFactory where T == _TokenRowViewModelFactory {
...
internal typealias _UnlockViewModelFactory = (
  ...
  _ validateMasterKey: @escaping (
    CoreKeychain.MasterKey, Login, AuthenticationMode, ThirdPartyOTPOption?
  ) async throws -> PairedServicesContainer,
  _ completion: @escaping (PairedServicesContainer) -> Void
) -> UnlockViewModel

extension InjectedFactory where T == _UnlockViewModelFactory {

...
struct HelpView: View {
  ...
  var list: some View {
    VStack(alignment: .leading, spacing: 16) {
      helpButton(
        title: L10n.Localizable.helpDashlaneCta,
        action: {
          helpItem = .dashlaneHelp
        })
      helpButton(
        title: L10n.Localizable.help2FaCta,
        action: {
          addAction(true)
        })
      helpButton(
        title: L10n.Localizable.helpTokenCta,
        action: {
          helpItem = .tokensHelp
        })
      helpButton(
        title: L10n.Localizable.helpCenterCta,
        action: {
          helpItem = .helpCenter
        })
      Spacer()
  ...
  var tokenHelpView: some View {
    NavigationView {
      TokenHelpView(
        title: L10n.Localizable.helpTokenTitle,

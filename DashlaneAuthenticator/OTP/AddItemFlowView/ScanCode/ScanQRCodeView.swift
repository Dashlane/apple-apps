...
struct ScanQRCodeView: View {
  ...
  var mainView: some View {
    ZStack {
      ...
      .alert(
        L10n.Localizable.enableCameraAlertTitle,
        isPresented: $isCameraAlertErrorPresented,
        actions: {
          Button(L10n.Localizable.enableCameraAlertCta, action: openSetting)
          Button(CoreLocalization.L10n.Core.cancel) {}
        },
        message: {
          Text(L10n.InfoPlist.nsCameraUsageDescription)
        }
      )
  ...
  var errorView: some View {
    FeedbackView(
      title: L10n.Localizable.qrcodeErrorTitle,
      ...
      secondaryButton: (
        L10n.Localizable.qrcodeErrorCancelTitle,
        {
          dismiss()
          showManualEntryView()
        }
...
struct ScanQRCodeView_Previews: PreviewProvider {
  static var previews: some View {
    NavigationView {
      ScanQRCodeView(
        model: ScanQRCodeViewModel(logger: LoggerMock(), completion: { _ in }),
        showManualEntryView: {})
    }
  }
}

...
class ChooseWebsiteViewModel: ObservableObject, AuthenticatorServicesInjecting, AuthenticatorMockInjecting {
    ...
    init(categorizer: CategorizerProtocol,
...
extension ChooseWebsiteViewModel {
    static func mock(includeSearchedWebsites: Bool = false,

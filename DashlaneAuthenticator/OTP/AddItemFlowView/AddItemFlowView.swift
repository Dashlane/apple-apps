  ...
  var navigationView: some View {
    StepBasedNavigationView(steps: $viewModel.steps) { step in
      ...
      case let .intro(hasAtLeastOneTokenStoredInVault):
        AddItemIntroView(hasAtLeastOneTokenStoredInVault: hasAtLeastOneTokenStoredInVault) {
          action in
          switch action {
          case .addToken:
      ...
      case .accountHelp:
        SetupHelpView(
          ...
          primaryButton: (
            title: L10n.Localizable.buttonTitleNext,
            action: {
      ...
      case .codeHelp:
        SetupHelpView(
          ...
          primaryButton: (
            title: L10n.Localizable.setupHelpAddTokenCta,
            action: {
              viewModel.steps.append(.setupMethod)
            }
          ),

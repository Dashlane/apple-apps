...
struct AuthenticationPushView_Previews: PreviewProvider {
    static var previews: some View {
        MultiContextPreview(deviceRange: .all) {
            AuthenticationPushView(pendingRequest: .constant([]), model: AuthenticationPushViewModel(notificationService: NotificationServiceMock(), request: AuthenticationRequest.mock, completion: {_ in }))
        }
    }
}

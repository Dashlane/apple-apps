...
class RatingService {
  ...
  @SharedUserDefault(
    key: Key.sessionCount, userDefaults: ApplicationGroup.authenticatorUserDefaults)
  var sessionCount: Int?

  @SharedUserDefault(
    key: Key.lastVersionPromptedForReview, userDefaults: ApplicationGroup.authenticatorUserDefaults)

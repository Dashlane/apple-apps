...
extension UserTrackingAppActivityReporter {
  ...
  static var authenticatorAnalyticsInstallationId: LowercasedUUID {
    var sharedDefault = SharedUserDefault<String?, String>(
      key: AuthenticatorKey.authenticatorAnalyticsInstallationId.rawValue,
...
extension AnonymousEvent.OtherAuthenticatorsInstalledReport {
  static var other2FAappsInstalled: [Definition.AuthenticatorNames] {
    ...
    for competitor in CompetitorsApplicationSchemeURL.allCases
    where UIApplication.shared.canOpenURL(competitor.url) {
...
extension CompetitorsApplicationSchemeURL {
  fileprivate var userTrackingDefinition: Definition.AuthenticatorNames {
    switch self {

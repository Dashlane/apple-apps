...
extension Definition {
  ...
  public enum `ClickOrigin`: String, Encodable, Sendable {
    ...
    case `adminProfiling` = "admin_profiling"
    case `adminTabExtensionInPopup` = "admin_tab_extension_in_popup"
    case `aiPhishingDetection` = "ai_phishing_detection"
    ...
    case `cancellationLossAversionModal` = "cancellation_loss_aversion_modal"
    ...
    case `dashlaneTooExpensiveModal` = "dashlane_too_expensive_modal"
    ...
    case `nudgesAdoption` = "nudges_adoption"
    case `nudgesCompromisedPasswords` = "nudges_compromised_passwords"
    case `nudgesPasskeys` = "nudges_passkeys"
    case `nudgesPhishing` = "nudges_phishing"
    case `nudgesReusedPasswords` = "nudges_reused_passwords"
    case `nudgesWeakPasswords` = "nudges_weak_passwords"
    case `onboardedUsersLimit` = "onboarded_users_limit"
    case `orderSummary` = "order_summary"
    case `phishingProtection` = "phishing_protection"
    case `plans`
    case `premiumPlanDetails` = "premium_plan_details"
    case `proTip` = "pro_tip"
    case `provisionRemainingSeatsReminder` = "provision_remaining_seats_reminder"
    ...
    case `subscriptionExpiredBanner` = "subscription_expired_banner"
    ...
    case `updateCreditCardReminder` = "update_credit_card_reminder"

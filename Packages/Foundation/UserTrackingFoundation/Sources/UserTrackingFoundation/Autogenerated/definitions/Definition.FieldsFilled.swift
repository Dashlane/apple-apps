...
extension Definition {
  ...
  public struct `FieldsFilled`: Encodable, Sendable {
    public init(
      ...
      `credential`: Int? = nil,
      `creditCard`: Int? = nil, `driverLicense`: Int? = nil, `email`: Int? = nil,
      `fiscalStatement`: Int? = nil,
      `generatedPassword`: Int? = nil, `idCard`: Int? = nil, `identity`: Int? = nil,
      `otp`: Int? = nil,
      `passkey`: Int? = nil, `passport`: Int? = nil, `paypal`: Int? = nil, `phone`: Int? = nil,
      `secureNote`: Int? = nil, `securityBreach`: Int? = nil, `socialSecurity`: Int? = nil,
      `website`: Int? = nil,
      `wifi`: Int? = nil
    ) {

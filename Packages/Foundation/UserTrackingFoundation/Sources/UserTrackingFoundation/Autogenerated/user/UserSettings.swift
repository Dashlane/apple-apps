...
extension UserEvent {
  ...
  public struct `UserSettings`: Encodable, UserEventProtocol {
    ...
    public init(
      ...
      `hasAutomaticTwoFactorAuthenticationTokenCopy`: Bool? = nil,
      `hasClearClipboard`: Bool? = nil, `hasCredentialsProtectWithMasterPassword`: Bool? = nil,
      ...
      `hasUnlockItemWithBiometric`: Bool? = nil,
      `lockAutoTimeout`: Int? = nil
    ) {

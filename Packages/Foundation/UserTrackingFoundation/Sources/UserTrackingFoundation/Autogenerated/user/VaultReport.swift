...
extension UserEvent {
  ...
  public struct `VaultReport`: Encodable, UserEventProtocol {
    ...
    public init(
      ...
      `passkeys`: Definition.ItemTypeCounts? = nil,
      `passwords`: Definition.ItemTypeCounts, `passwordsCompromisedCount`: Int,
      `passwordsCompromisedThroughDarkWebCount`: Int? = nil, `passwordsExcludedCount`: Int,
      `passwordsProtectedWithMasterPasswordCount`: Int? = nil, `passwordsReusedCount`: Int,
      `passwordsSafeCount`: Int, `passwordsWeakCount`: Int,
      `passwordsWithAutologinDisabledCount`: Int? = nil,
      `passwordsWithOtpCount`: Int, `payments`: Definition.ItemTypeCounts,
      `personalInfo`: Definition.ItemTypeCounts, `scope`: Definition.Scope,
      `secrets`: Definition.ItemTypeCounts? = nil, `secureNotes`: Definition.ItemTypeCounts,
      `securityAlertsActiveCount`: Int? = nil, `securityAlertsCount`: Int? = nil,

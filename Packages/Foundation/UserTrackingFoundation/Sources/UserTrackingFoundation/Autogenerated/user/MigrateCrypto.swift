...
extension UserEvent {
  ...
  public struct `MigrateCrypto`: Encodable, UserEventProtocol {
    ...
    public init(
      `newCrypto`: Definition.CryptoAlgorithm, `previousCrypto`: Definition.CryptoAlgorithm,
      `status`: Definition.CryptoMigrationStatus, `type`: Definition.CryptoMigrationType
    ) {

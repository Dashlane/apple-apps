...
extension UserEvent {
  ...
  public struct `Sync`: Encodable, UserEventProtocol {
    ...
    public init(
      ...
      `errorName`: Definition.ErrorName? = nil,
      `errorStep`: Definition.ErrorStep? = nil, `extent`: Definition.Extent,
      `fullBackupSize`: Int? = nil,
      `incomingDeleteCount`: Int? = nil, `incomingUpdateCount`: Int? = nil,
      `itemGroupId`: String? = nil,

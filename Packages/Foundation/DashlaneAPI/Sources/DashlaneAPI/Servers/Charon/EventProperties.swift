...
extension CharonDataAPIClient {
  ...
  public struct Properties {
    ...
    public struct Login: Codable {
      ...
      public init(
        status: String? = nil, mode: String? = nil, isFirstLogin: Bool? = nil,
        isBackupCode: Bool? = nil, verificationMode: String? = nil
      ) {
        self.status = status
        self.mode = mode
    ...
    public struct PerformAutofill: Codable {
      ...
      public init(
        autofillMechanism: String? = nil, autofillOrigin: String? = nil,
        formTypeList: [String]? = nil, isAutologin: Bool? = nil, isManual: Bool? = nil,
        isNativeApp: Bool? = nil, matchType: String? = nil, domain: Domain? = nil
      ) {
    ...
    public struct AutofillDismiss: Codable {
      public var name = "autofill_dismiss"
      public var dismissType: String?

      public init(dismissType: String? = nil) {
    ...
    public struct CallToAction: Codable {
      ...
      public init(
        callToActionList: [String]? = nil, chosenAction: String? = nil,
        hasChosenNoAction: Bool? = nil
      ) {
    ...
    public struct UpdateCredential: Codable {
      ...
      public init(
        action: String? = nil, space: String? = nil, fieldList: [String]? = nil,
        associatedWebsitesAddedList: [String]? = nil,
        associatedWebsitesRemovedList: [String]? = nil, domain: Domain? = nil
      ) {
        self.action = action
        self.space = space
    ...
    public struct UpdateVaultItem: Codable {
      ...
      public init(
        action: String? = nil, fieldsEdited: [String]? = nil, itemType: String? = nil,
        space: String? = nil, updateCredentialOrigin: String? = nil, itemId: String? = nil
      ) {
        self.action = action
    ...
    public struct CopyVaultItemField: Codable {
      ...
      public init(
        itemType: String? = nil, field: String? = nil, isProtected: Bool? = nil,
        itemId: String? = nil
      ) {
        self.itemType = itemType
        self.field = field
    ...
    public struct ImportData: Codable {
      ...
      public init(
        backupFileType: String? = nil, importDataStatus: String? = nil, importSource: String? = nil
      ) {
        self.backupFileType = backupFileType
    ...
    public struct GeneratePassword: Codable {
      ...
      public init(
        length: Int? = nil, hasDigits: Bool? = nil, hasLetters: Bool? = nil,
        hasSymbols: Bool? = nil, hasSimilar: Bool? = nil
      ) {
        self.length = length

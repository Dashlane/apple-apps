...
struct StyxDataAPIClientEngineImpl: StyxDataAPIClientEngine {
    ...
    func post(_ endpoint: Endpoint, data: Data, signer: RequestSigner, isTestEnvironment: Bool) async throws {
        ...
        try request.sign(with: signer, timeshift: try await apiClientEngine.timeshift)
...
fileprivate extension URLSession {
    func styxResponse(from urlRequest: URLRequest, using decoder: JSONDecoder) async throws {

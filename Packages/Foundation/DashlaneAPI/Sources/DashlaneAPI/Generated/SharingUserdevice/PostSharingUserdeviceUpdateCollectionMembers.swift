...
extension UserDeviceAPIClient.SharingUserdevice {
        public struct UpdateCollectionMembers: APIRequest {
        public static let endpoint: Endpoint = "/sharing-userdevice/UpdateCollectionMembers"

        public let api: UserDeviceAPIClient

                public func callAsFunction(revision: Int, collectionUUID: String, userGroups: [UserGroupCollectionUpdate]? = nil, users: [UserCollectionUpdate]? = nil, timeout: TimeInterval? = nil) async throws -> Response {

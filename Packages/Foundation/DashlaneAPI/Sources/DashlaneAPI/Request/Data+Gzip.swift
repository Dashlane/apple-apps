...
extension Data {
    ...
    public func gzipCompressed() -> Data? {
        ...
        zstream.opaque = nil 
                ...
                var status = deflateInit2_(&zstream, 5, Z_DEFLATED, 15 + 16, 8, Z_DEFAULT_STRATEGY, ZLIB_VERSION, Int32(MemoryLayout<z_stream>.size))
    ...
    public func gzipDecompressed() -> Data? {
        ...
        var status = inflateInit2_(&zstream, 15 + 16, ZLIB_VERSION, Int32(MemoryLayout<z_stream>.size))

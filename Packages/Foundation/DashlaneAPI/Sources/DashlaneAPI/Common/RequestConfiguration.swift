...
public struct RequestConfiguration<Client: OpenAPISpecClient>: Sendable {
...
extension RequestConfiguration.Environment {
  var apiURL: URL {
    switch self {
    case .production:
...
extension URLRequest {
  init(
    ...
    configuration: RequestConfiguration<some OpenAPISpecClient>
  ) {
...
extension RequestConfiguration {
  ...
  static func makeAdditionalHeaders(
    info: ClientInfo, environment: RequestConfiguration<some OpenAPISpecClient>.Environment

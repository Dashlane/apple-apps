...
public struct GravityAreaVStack<Top: View, Center: View, Bottom: View>: View {
  ...
  public init(
    top: Top, center: Center, bottom: Bottom, alignment: HorizontalAlignment = .center,
    spacing: CGFloat? = nil
  ) {
    self.top = top
    self.center = center
...
extension GravityAreaVStack where Bottom == Spacer {
  public init(
    top: Top, center: Center, alignment: HorizontalAlignment = .center, spacing: CGFloat? = nil
  ) {
...
extension GravityAreaVStack where Top == Spacer {
  public init(
    center: Center, bottom: Bottom, alignment: HorizontalAlignment = .center,
    spacing: CGFloat? = nil
  ) {
...
extension GravityAreaVStack where Center == Spacer {
  public init(
    top: Top, bottom: Bottom, alignment: HorizontalAlignment = .center, spacing: CGFloat? = nil
  ) {

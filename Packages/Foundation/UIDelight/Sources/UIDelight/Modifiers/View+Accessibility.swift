...
extension View {
  ...
  @ViewBuilder
  public func fiberAccessibilityElement(children: AccessibilityChildBehavior = .ignore) -> some View
  {
    if ProcessInfo.isTesting {
      self
    } else {
  ...
  @ViewBuilder
  public func fiberAccessibilityFocus(_ binding: AccessibilityFocusState<Bool>.Binding) -> some View
  {
    if ProcessInfo.isTesting {
      self
    } else {

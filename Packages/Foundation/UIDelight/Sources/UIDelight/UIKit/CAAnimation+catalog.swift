...
extension CAAnimation {
  public func delayed(by delay: TimeInterval) -> CAAnimation {
  ...
  public static var fadeIn: CABasicAnimation {
  ...
  public static var fadeOut: CABasicAnimation {
    let fade = CABasicAnimation(keyPath: "opacity")
    fade.toValue = 0
    fade.speed = 1.2
    fade.fillMode = CAMediaTimingFillMode.both
  ...
  public static func slide(from offset: CGPoint) -> CAAnimation {
  ...
  public static func slide(to offset: CGPoint) -> CAAnimation {
    let slide = CABasicAnimation(keyPath: "position")
    slide.isAdditive = true
  ...
  public static func slideIn(
    with direction: SlideDirection, containerSize: CGSize, shouldFade: Bool
  ) -> CAAnimation {

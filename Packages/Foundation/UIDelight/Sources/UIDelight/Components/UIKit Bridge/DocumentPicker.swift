...
extension View {
  ...
  public func documentPicker(export fileURL: Binding<URL?>, completion: @escaping () -> Void)
    -> some View
  {
    background(
  ...
  public func documentPicker(
    open contentTypes: [UTType], isPresented: Binding<Bool>, completion: @escaping (Data?) -> Void
  ) -> some View {
    background(
...
private final class DocumentPickerControllerWrapper: UIViewController, UIDocumentPickerDelegate,

...
private extension AsyncDelayingScheduler {
    func throttleKeepFirst(operation: @escaping () async throws -> Void) {
    ...
    func throttleKeepLast(operation: @escaping () async throws -> Void) {

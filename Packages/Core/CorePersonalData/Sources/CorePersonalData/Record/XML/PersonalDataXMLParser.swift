...
final class PersonalDataXMLParser: NSObject {
  ...
  func parse(_ xmlData: Data, forTransactionType expectedType: PersonalDataContentType) throws
  ...
  func parse(_ xmlString: String, forTransactionType expectedType: PersonalDataContentType) throws
    -> PersonalDataCollection
  {
...
extension Node {
  fileprivate func syncedContentValue() -> PersonalDataValue? {
    switch type {
    case .item:

...
struct UnkeyedDecodeContainer: UnkeyedDecodingContainer {
    ...
    guard !self.isAtEnd else {
      throw DecodingError.valueNotFound(
        ...
        DecodingError.Context(
          codingPath: self.codingPath, debugDescription: "Unkeyed container is at end."))
    }
  ...
  private func currentDecoder() throws -> PersonalDataDecoderImpl {
    return try PersonalDataDecoderImpl(
      value: current(), codingPath: currentCodingPath(), options: options)
  }

...
@PersonalData
public struct SecurityBreach: Equatable {
  ...
  init(
    id: Identifier, breachId: String, content: String, contentRevision: String? = nil,
    leakedPasswords: String? = nil, status: SecurityBreach.Status? = nil,

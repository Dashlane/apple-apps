...
public enum ControlledFeature: String, CaseIterable, Sendable {
  ...
  case changeLoginEmail = "account_management_change_login_email_ios"
  case wifiCredential = "apple_wifi_credential"
  case encryptedSharingAuditLogDetail =
    "setup_rollout_apple_encrypted_sharing_audit_log_details_dev"
  case importDataButton = "platform_apple_import_improvement_dev"

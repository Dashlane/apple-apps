...
public struct PasswordField: View {
    ...
    public init(_ placeholder: LocalizedStringKey, text: Binding<String>, isFocused: Binding<Bool> = .constant(false), onSubmit: (() -> Void)? = nil) {
    ...
    public init(_ placeholder: String, text: Binding<String>, isFocused: Binding<Bool> = .constant(false), onSubmit: (() -> Void)? = nil) {
        self.init(LocalizedStringKey(placeholder), text: text, isFocused: isFocused, onSubmit: onSubmit)
    }
    ...
    public var body: some View {
        ...
        .onChange(of: isFocused.wrappedValue, perform: { focus in
            if focus {

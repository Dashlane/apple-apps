  ...
  extension DashlaneNavigationController: Navigator {
    ...
    public func push<Content>(_ view: Content, barStyle: NavigationBarStyle, animated: Bool)
    where Content: View {
    ...
    public func showDetail<Content: View>(
      _ view: Content, barStyle: NavigationBarStyle, animated: Bool
    ) {
      let controller = makeContentViewController(for: view.dashlaneDefaultStyle(), using: barStyle)
    ...
    public func present<Content: View>(
      ...
      let controller = makeContentViewController(
        for: view.dashlaneDefaultStyle(), using: .default())
      self.present(
    ...
    @discardableResult
    public func presentAsModal(
      _ viewController: UIViewController, style: UIModalPresentationStyle,
      barStyle: NavigationBarStyle = .default(), animated: Bool
    ) -> DashlaneNavigationController {
  ...
  public final class NavigationContentHostingController<T: View>: UIHostingController<T>,
    NavigationBarStyleProvider
  {
    ...
    public override func viewWillAppear(_ animated: Bool) {
      ...
      dashlaneNavigationController?.setNavigationBarHidden(
        using: navigationBarStyle, animated: animated)
    }

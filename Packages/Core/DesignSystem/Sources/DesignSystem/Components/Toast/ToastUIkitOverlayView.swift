  ...
  struct ToastUIKitOverlay: View {
    ...
    func updateToastPosition() {
      ...
      if let rootViewController = UIApplication.shared.keyUIWindow?.rootViewController
    ...
    public func turnOnToaster() {
      ...
      NSLayoutConstraint.activate([
        ...
        controller.view.bottomAnchor.constraint(
          greaterThanOrEqualTo: view.bottomAnchor, constant: 0),
      ])
    ...
    static let viewController: UIViewController = {
      ...
      NSLayoutConstraint.activate([
        hosting.view.leadingAnchor.constraint(
          equalTo: viewController.view.leadingAnchor, constant: 0),
        hosting.view.trailingAnchor.constraint(
          equalTo: viewController.view.trailingAnchor, constant: 0),

...
extension UIImage {
  public enum ds {
    ...
    public enum api {
      public static let outlined = UIImage("api/outlined")
    }
    ...
    public enum `extension` {
      public static let filled = UIImage("extension/filled")
      public static let outlined = UIImage("extension/outlined")
    }
    public enum faceDisappointed {
      public static let outlined = UIImage("face-disappointed/outlined")
    }
    public enum faceId {
      public static let outlined = UIImage("face-id/outlined")
    }
    public enum faceNeutral {
      public static let outlined = UIImage("face-neutral/outlined")
    }
    public enum faceSatisfied {
      public static let outlined = UIImage("face-satisfied/outlined")
    }
    public enum feature {
    ...
    public enum `import` {
      public static let outlined = UIImage("import/outlined")
    }
    public enum indentation {
      public static let outlined = UIImage("indentation/outlined")
    }
    public enum item {
      ...
      public enum wifi {
        public static let outlined = UIImage("item/wifi/outlined")
      }
    }
    ...
    public enum os {
      public enum android {
        public static let filled = UIImage("os/android/filled")
      }
      public enum apple {
        public static let filled = UIImage("os/apple/filled")
      }
      public enum linux {
        public static let filled = UIImage("os/linux/filled")
      }
      public enum windows {
        public static let filled = UIImage("os/windows/filled")
      }
    }
    public enum passkey {
    ...
    public enum qrCode {
      public static let outlined = UIImage("qr-code/outlined")
    }
    ...
    public enum social {
      public enum bluesky {
        public static let filled = UIImage("social/bluesky/filled")
      }

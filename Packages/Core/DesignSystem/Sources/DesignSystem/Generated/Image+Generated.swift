...
extension Image {
  public enum ds {
    ...
    public enum caretDoubleRight {
      public static let outlined = Image("caret-double-right/outlined")
    }
    ...
    public enum collection {
      public static let outlined = Image("collection/outlined")
    }
    ...
    public enum formatting {
      public enum bold {
        public static let outlined = Image("formatting/bold/outlined")
      }
      public enum code {
        public static let outlined = Image("formatting/code/outlined")
      }
      public enum heading1 {
        public static let outlined = Image("formatting/heading1/outlined")
      }
      public enum heading2 {
        public static let outlined = Image("formatting/heading2/outlined")
      }
      public enum heading3 {
        public static let outlined = Image("formatting/heading3/outlined")
      }
      public enum italic {
    ...
    public enum item {
      ...
      public enum fax {
        public static let outlined = Image("item/fax/outlined")
      }
      public enum id {
      ...
      public enum secret {
        public static let outlined = Image("item/secret/outlined")
      }
    ...
    public enum social {
      ...
      public enum threads {
        public static let filled = Image("social/threads/filled")
      }
      public enum twitter {

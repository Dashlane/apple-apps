    ...
    public enum ds {
        ...
        public enum feature {
            public enum authenticator {
                public static let filled = Bundle.module.image(forResource: "feature/authenticator/filled")
                public static let outlined = Bundle.module.image(forResource: "feature/authenticator/outlined")
            }
            ...
            public enum darkWebMonitoring {
                public static let outlined = Bundle.module.image(forResource: "feature/dark-web-monitoring/outlined")
            }
            public enum inboxScan {
                public static let outlined = Bundle.module.image(forResource: "feature/inbox-scan/outlined")
            }
            public enum passwordGenerator {
                public static let filled = Bundle.module.image(forResource: "feature/password-generator/filled")
                public static let outlined = Bundle.module.image(forResource: "feature/password-generator/outlined")
            }
            public enum passwordHealth {
                public static let outlined = Bundle.module.image(forResource: "feature/password-health/outlined")
            }
            public enum vpn {
        ...
        public enum item {
            public enum bankAccount {
                ...
                public static let outlined = Bundle.module.image(forResource: "item/bank-account/outlined")
            }
            public enum company {
            ...
            public enum driversLicense {
                public static let outlined = Bundle.module.image(forResource: "item/drivers-license/outlined")
            }
            public enum email {
            ...
            public enum personalInfo {
                ...
                public static let outlined = Bundle.module.image(forResource: "item/personal-info/outlined")
            }
            ...
            public enum phoneMobile {
                ...
                public static let outlined = Bundle.module.image(forResource: "item/phone-mobile/outlined")
            }
            ...
            public enum socialSecurity {
                ...
                public static let outlined = Bundle.module.image(forResource: "item/social-security/outlined")
            }
        ...
        public enum premiumStar {
            public static let filled = Bundle.module.image(forResource: "premium-star/filled")
            public static let outlined = Bundle.module.image(forResource: "premium-star/outlined")
        }

...
enum ColorGeneratorError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .darkAndLightPalettesNotIdentical(let differences):
            let header = "Color generation failed because light mode and dark mode color palettes on Specify contain different values. For color assets to be generated, it's required that the two palettes have identical set of colors."

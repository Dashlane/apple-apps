...
struct ZlibCompressor {
  ...
  static func deflate(string: String, compressionLevel: Int = defaultCompressionLevel) throws
    -> Data
  {
  ...
  static func deflate(data inputData: Data, compressionLevel: Int = defaultCompressionLevel) throws
    -> Data
  {
    ...
    try inputData.withUnsafeBytes { (inputPointer: UnsafeRawBufferPointer) in
      ...
      let initResult = deflateInit_(
        &stream, Int32(compressionLevel), zlibVersion(), Int32(MemoryLayout<z_stream>.size))
...
extension Data {
  ...
  public func decompressQtCompressedData() throws -> Data {
  ...
  public func decompressQtCompressedDataToString() throws -> String? {

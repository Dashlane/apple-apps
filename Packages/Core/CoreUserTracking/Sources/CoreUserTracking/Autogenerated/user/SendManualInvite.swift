...
public init(`flowStep`: Definition.FlowStep, `importSize`: Int? = nil, `initialSeatCount`: Int? = nil, `inviteCount`: Int, `inviteFailedCount`: Int, `inviteResentCount`: Int, `inviteSuccessfulCount`: Int, `isImport`: Bool, `isResend`: Bool, `seatAddedCount`: Int? = nil) {

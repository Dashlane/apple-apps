...
extension UserEvent {
  ...
  public struct `PerformAutofill`: Encodable, UserEventProtocol {
    ...
    public init(
      ...
      `autofillOrigin`: Definition.AutofillOrigin, `credentialFilledItemId`: String? = nil,
      `fieldsFilled`: Definition.FieldsFilled? = nil, `formTypeList`: [Definition.FormType]? = nil,
      `isAutologin`: Bool, `isManual`: Bool, `itemSource`: Definition.ItemSource? = nil,
      `matchType`: Definition.MatchType, `mobileBrowserName`: String? = nil,

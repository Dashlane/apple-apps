...
public init(`collectionsPerItemAverageCount`: Int? = nil, `collectionsSharedCount`: Int? = nil, `collectionsTotalCount`: Int? = nil, `darkWebAlertsActiveCount`: Int? = nil, `darkWebAlertsCount`: Int? = nil, `domainsWithoutAutofillCount`: Int? = nil, `ids`: Definition.ItemTypeCounts, `itemsPerCollectionAverageCount`: Int? = nil, `itemsSharedCount`: Int? = nil, `itemsTotalCount`: Int? = nil, `passwords`: Definition.ItemTypeCounts, `passwordsCompromisedCount`: Int, `passwordsCompromisedThroughDarkWebCount`: Int? = nil, `passwordsExcludedCount`: Int, `passwordsProtectedWithMasterPasswordCount`: Int? = nil, `passwordsReusedCount`: Int, `passwordsSafeCount`: Int, `passwordsWeakCount`: Int, `passwordsWithAutologinDisabledCount`: Int? = nil, `passwordsWithOtpCount`: Int, `payments`: Definition.ItemTypeCounts, `personalInfo`: Definition.ItemTypeCounts, `scope`: Definition.Scope, `secureNotes`: Definition.ItemTypeCounts, `securityAlertsActiveCount`: Int? = nil, `securityAlertsCount`: Int? = nil, `securityScore`: Int? = nil) {

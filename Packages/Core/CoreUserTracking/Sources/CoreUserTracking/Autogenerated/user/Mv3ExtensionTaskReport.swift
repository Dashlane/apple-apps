...
public init(`businessDomain`: Definition.BusinessDomain, `feature`: String, `hasWokenUpServiceWorker`: Bool? = nil, `serviceWorkerInterruptionCount`: Int, `serviceWorkerStartDateTime`: Date, `taskEndDateTime`: Date, `taskName`: String, `taskStartDateTime`: Date) {

...
public init(`deduplicates`: Int? = nil, `duration`: Definition.Duration, `error`: Definition.Error? = nil, `errorDescription`: Definition.ErrorDescription? = nil, `errorName`: Definition.ErrorName? = nil, `errorStep`: Definition.ErrorStep? = nil, `extent`: Definition.Extent, `fullBackupSize`: Int? = nil, `incomingDeleteCount`: Int? = nil, `incomingUpdateCount`: Int? = nil, `itemGroupId`: String? = nil, `outgoingDeleteCount`: Int? = nil, `outgoingUpdateCount`: Int? = nil, `timestamp`: Int, `treatProblem`: Definition.TreatProblem? = nil, `trigger`: Definition.Trigger) {

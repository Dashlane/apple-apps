...
public init(`androidMarketing`: Definition.Android? = nil, `iosMarketing`: Definition.Ios? = nil, `isMarketingOptIn`: Bool, `status`: Definition.AccountCreationStatus, `webMarketing`: Definition.WebAccountCreation? = nil) {

...
public init(`currentBillingPlanTier`: Definition.B2BPlanTier, `currentPlanPaidSeatsCount`: Int, `hasPromo`: Bool? = nil, `nextBillingPlanTier`: Definition.B2BPlanTier, `planChangeStep`: Definition.PlanChangeStep, `seatAddedCount`: Int) {

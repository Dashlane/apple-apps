...
extension UserEvent {
  ...
  public struct `ImportData`: Encodable, UserEventProtocol {
    ...
    public init(
      ...
      `importDataStatus`: Definition.ImportDataStatus, `importDataStep`: Definition.ImportDataStep,
      `importSource`: Definition.ImportSource, `importedItemsCount`: Int? = nil,
      `isDirectImport`: Bool, `itemsToImportCount`: Int? = nil, `space`: Definition.Space? = nil
    ) {

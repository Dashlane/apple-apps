...
public init(`errorCheckout`: Definition.ErrorCheckout? = nil, `flowStep`: Definition.FlowStep, `hasPromo`: Bool, `initialSeatCount`: Int, `priceAmountCents`: Int, `priceCurrencyCode`: Definition.PriceCurrencyCode, `purchasedSeatCount`: Int) {

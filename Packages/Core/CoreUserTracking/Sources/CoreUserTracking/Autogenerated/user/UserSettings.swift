...
public init(`hasAuthenticationWithBiometrics`: Bool? = nil, `hasAuthenticationWithPin`: Bool? = nil, `hasAuthenticationWithRememberMe`: Bool? = nil, `hasAuthenticationWithWebauthn`: Bool? = nil, `hasAutofillActivated`: Bool? = nil, `hasAutomaticTwoFactorAuthenticationTokenCopy`: Bool? = nil, `hasClearClipboard`: Bool? = nil, `hasCredentialsProtectWithMasterPassword`: Bool? = nil, `hasIdsProtectWithMasterPassword`: Bool? = nil, `hasLockOnExit`: Bool? = nil, `hasMasterPasswordBiometricReset`: Bool? = nil, `hasPaymentsProtectWithMasterPassword`: Bool? = nil, `hasSecureNotesProtectWithMasterPassword`: Bool? = nil, `hasUnlockItemWithBiometric`: Bool? = nil, `lockAutoTimeout`: Int? = nil) {
...
self.hasAutomaticTwoFactorAuthenticationTokenCopy = hasAutomaticTwoFactorAuthenticationTokenCopy

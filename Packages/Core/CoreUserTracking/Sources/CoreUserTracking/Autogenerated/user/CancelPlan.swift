...
public init(`cancelPlanStep`: Definition.CancelPlanStep, `plan`: Definition.Plan, `planBillingPeriod`: Definition.PlanBillingPeriod, `surveyAnswer`: Definition.SurveyAnswer? = nil) {

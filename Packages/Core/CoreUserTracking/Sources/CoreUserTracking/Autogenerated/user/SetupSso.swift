...
extension UserEvent {
  ...
  public struct `SetupSso`: Encodable, UserEventProtocol {
    ...
    public init(
      `emailDomainError`: Definition.EmailDomainError, `emailDomainSubmittedCount`: Int,
      `emailDomainValidatedCount`: Int,
      `encryptionServicePlatformSelected`: Definition.EncryptionServicePlatformSelected,
      `idpValidationResponse`: Definition.IdpValidationResponse,
      `ssoSetupStep`: Definition.SsoSetupStep, `ssoSolutionChosen`: Definition.SsoSolutionChosen,
      `testSsoResponse`: Definition.TestSsoResponse
    ) {

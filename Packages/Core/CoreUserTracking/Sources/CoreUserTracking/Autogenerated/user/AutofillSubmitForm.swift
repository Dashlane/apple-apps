...
extension UserEvent {
  ...
  public struct `AutofillSubmitForm`: Encodable, UserEventProtocol {
    ...
    public init(
      `fieldsDetectedByAnalysisEngineCount`: Int, `fieldsFilledBy`: Definition.FieldsFilledByCount,
      `formLoadedAtDateTime`: Date, `formSubmittedAtDateTime`: Date,
      `formType`: Definition.FormType, `hasModifiedInitiallyAutofilledValue`: Bool,
      `hasPasswordField`: Bool, `totalFormFieldsCount`: Int
    ) {

...
extension AnonymousEvent {
  ...
  public struct `AutofillSuggest`: Encodable, AnonymousEventProtocol {
    ...
    public init(
      ...
      `domain`: Definition.Domain, `isLoginPrefilled`: Bool? = nil, `isNativeApp`: Bool,
      `isPasswordPrefilled`: Bool? = nil, `isSuggestLastUnsaved`: Bool? = nil,
      `msToWebcard`: Int? = nil, `phishingRisk`: Definition.PhishingRisk? = nil,
      `vaultTypeList`: [Definition.ItemType]? = nil, `webcardItemTotalCount`: Int? = nil,

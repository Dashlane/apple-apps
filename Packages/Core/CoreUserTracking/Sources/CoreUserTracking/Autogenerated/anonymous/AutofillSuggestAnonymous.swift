...
public init(`autofillMessageTypeList`: [Definition.AutofillMessageType]? = nil, `domain`: Definition.Domain, `isLoginPrefilled`: Bool? = nil, `isNativeApp`: Bool, `isPasswordPrefilled`: Bool? = nil, `isSuggestLastUnsaved`: Bool? = nil, `msToWebcard`: Int? = nil, `vaultTypeList`: [Definition.ItemType]? = nil, `webcardItemTotalCount`: Int? = nil, `webcardSaveOptions`: [Definition.WebcardSaveOptions]? = nil) {

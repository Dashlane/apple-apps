...
extension AnonymousEvent {
  ...
  public struct `AddTwoFactorAuthenticationToCredential`: Encodable, AnonymousEventProtocol {
    ...
    public init(
      `authenticatorIssuerId`: String? = nil, `domain`: Definition.Domain? = nil,
      `flowStep`: Definition.FlowStep, `otpAdditionError`: Definition.OtpAdditionError? = nil,
      `otpAdditionMode`: Definition.OtpAdditionMode,
      `otpSpecifications`: Definition.OtpSpecifications? = nil, `space`: Definition.Space? = nil
    ) {

...
extension AnonymousEvent {
  ...
  public struct `RightClickMenuAction`: Encodable, AnonymousEventProtocol {
    ...
    public init(
      `domain`: Definition.Domain, `fieldFilled`: Definition.ItemType? = nil,
      `fieldInitialClassificationList`: [Definition.ItemType]? = nil,
      `isFieldDetectedByAnalysisEngine`: Bool, `isNativeApp`: Bool,
      `rightClickMenuFlowStep`: Definition.RightClickMenuFlowStep
    ) {
      self.domain = domain

...
public init(`algorithmsSupportedList`: [Definition.AlgorithmsSupported]? = nil, `authenticatorAttachment`: Definition.AuthenticatorAttachment? = nil, `authenticatorResidentKey`: Definition.AuthenticatorResidentKey? = nil, `authenticatorUserVerification`: Definition.AuthenticatorUserVerification? = nil, `domain`: Definition.Domain, `isRegisteredWithDashlane`: Bool? = nil, `msToCompleteRegistration`: Int? = nil, `msToCompleteRegistrationTimeout`: Int? = nil, `passkeyRegistrationErrorType`: Definition.PasskeyRegistrationErrorType? = nil, `passkeyRegistrationStatus`: Definition.CeremonyStatus, `webauthnExtensionSupportedList`: [Definition.WebauthnExtensionId]? = nil) {

...
public init(`authenticationMediationType`: Definition.AuthenticationMediationType? = nil, `authenticatorUserVerification`: Definition.AuthenticatorUserVerification? = nil, `domain`: Definition.Domain, `hasCredentialsAllowed`: Bool? = nil, `isAuthenticatedWithDashlane`: Bool? = nil, `msToCompleteAuthentication`: Int? = nil, `msToCompleteAuthenticationTimeout`: Int? = nil, `passkeyAuthenticationErrorType`: Definition.PasskeyAuthenticationErrorType? = nil, `passkeyAuthenticationStatus`: Definition.CeremonyStatus, `webauthnExtensionSupportedList`: [Definition.WebauthnExtensionId]? = nil) {

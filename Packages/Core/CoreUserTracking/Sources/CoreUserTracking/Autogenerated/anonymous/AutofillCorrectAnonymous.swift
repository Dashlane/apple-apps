...
public init(`correctionType`: Definition.CorrectionType, `domain`: Definition.Domain, `fieldCorrected`: Definition.ItemType, `initialFieldClassificationList`: [Definition.ItemType]? = nil, `isNativeApp`: Bool, `newFieldClassification`: Definition.ItemType? = nil) {

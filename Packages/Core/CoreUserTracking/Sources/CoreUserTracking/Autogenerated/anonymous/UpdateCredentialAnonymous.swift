...
public init(`action`: Definition.Action, `associatedAppsAddedList`: [String]? = nil, `associatedAppsRemovedList`: [String]? = nil, `associatedWebsitesAddedList`: [String]? = nil, `associatedWebsitesRemovedList`: [String]? = nil, `credentialOriginalSecurityStatus`: Definition.CredentialSecurityStatus? = nil, `credentialSecurityStatus`: Definition.CredentialSecurityStatus? = nil, `domain`: Definition.Domain, `fieldList`: [Definition.Field]? = nil, `isCredentialCurrentlyEligibleToPasswordChanger`: Bool? = nil, `space`: Definition.Space, `updateCredentialOrigin`: Definition.UpdateCredentialOrigin? = nil) {
self.action = action
...
self.isCredentialCurrentlyEligibleToPasswordChanger = isCredentialCurrentlyEligibleToPasswordChanger
self.space = space

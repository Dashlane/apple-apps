...
public init(`bulkChangeCredentialCount`: Int? = nil, `domain`: Definition.Domain, `isBulkChange`: Bool, `isSuccess`: Bool, `lastRecipeStepPosition`: Int, `passwordChangerFailureReason`: Definition.PasswordChangerFailureReason? = nil, `passwordChangerRecipeVersion`: String? = nil) {

...
public struct `User`<Event: UserEventProtocol>: Encodable {
public init(`browse`: Definition.Browse, `context`: Definition.Context, `date`: Date, `dateOrigin`: Definition.DateOrigin, `id`: LowercasedUUID, `session`: Definition.Session? = nil, properties: Event) {
self.browse = browse

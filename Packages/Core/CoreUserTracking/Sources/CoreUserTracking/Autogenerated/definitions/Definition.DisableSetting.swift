...
public struct `DisableSetting`: Encodable {
public init(`configuration`: Definition.AutofillConfiguration? = nil, `durationSetting`: Definition.AutofillDurationSetting? = nil, `scope`: Definition.AutofillScope? = nil) {

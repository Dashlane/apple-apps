...
extension Definition {
  ...
  public struct `ItemTypeCounts`: Encodable, Sendable {
    public init(
      `collectionsCount`: Int? = nil, `collectionsSharedCount`: Int? = nil,
      `multipleCollectionsCount`: Int? = nil, `multipleCollectionsSharedCount`: Int? = nil,
      `sharedCount`: Int? = nil, `singleCollectionCount`: Int? = nil,
      `singleCollectionSharedCount`: Int? = nil, `totalCount`: Int
    ) {

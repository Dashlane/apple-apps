...
public struct `OtpSpecifications`: Encodable {
public init(`durationOtpValidity`: Int? = nil, `encryptionAlgorithm`: Definition.EncryptionAlgorithm? = nil, `otpCodeSize`: Int? = nil, `otpIncrementCount`: Int? = nil, `otpType`: Definition.OtpType) {

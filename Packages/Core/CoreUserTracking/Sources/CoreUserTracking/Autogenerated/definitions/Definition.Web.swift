...
public struct `Web`: Encodable {
public init(`everflowTransactionId`: String? = nil, `gclid`: String? = nil, `hasCookie`: Bool, `heapIdentity`: String? = nil, `utmCampaign`: String? = nil, `utmContent`: String? = nil, `utmLastClickCampaign`: String? = nil, `utmLastClickContent`: String? = nil, `utmLastClickMedium`: String? = nil, `utmLastClickPathname`: String? = nil, `utmLastClickReferrer`: String? = nil, `utmLastClickSource`: String? = nil, `utmLastClickTerm`: String? = nil, `utmLastClickVisitTimestamp`: Int? = nil, `utmMedium`: String? = nil, `utmPathname`: String? = nil, `utmReferrer`: String? = nil, `utmSource`: String? = nil, `utmTerm`: String? = nil, `utmVisitTimestamp`: Int? = nil) {

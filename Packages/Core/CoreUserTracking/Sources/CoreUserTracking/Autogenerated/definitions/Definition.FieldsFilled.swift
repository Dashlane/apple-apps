...
public struct `FieldsFilled`: Encodable {
public init(`address`: Int? = nil, `bankStatement`: Int? = nil, `company`: Int? = nil, `credential`: Int? = nil, `creditCard`: Int? = nil, `driverLicense`: Int? = nil, `email`: Int? = nil, `fiscalStatement`: Int? = nil, `generatedPassword`: Int? = nil, `idCard`: Int? = nil, `identity`: Int? = nil, `passport`: Int? = nil, `paypal`: Int? = nil, `phone`: Int? = nil, `secureNote`: Int? = nil, `securityBreach`: Int? = nil, `socialSecurity`: Int? = nil, `website`: Int? = nil) {

...
extension SessionDirectory {
  public func copyStore(
    for identifier: StoreIdentifier, from source: BuildTarget = .app, to target: BuildTarget
  ) throws {
  ...
  public func copyUnsharedStores(from source: BuildTarget = .app, to target: BuildTarget) throws {

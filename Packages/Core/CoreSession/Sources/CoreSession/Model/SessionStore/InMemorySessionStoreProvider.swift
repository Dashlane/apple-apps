...
public class InMemorySessionStoreProvider: SessionStoreProviderProtocol {
  ...
  public func infoStore(for login: Login, directory: SessionDirectory) throws
    -> InMemorySessionStore<SessionInfo>
  {
  ...
  ) throws -> InMemorySessionStore<Data> {
  ...
  public func keysStore(
    ...
    info: SessionInfo
  ) throws -> InMemorySessionStore<SessionSecureKeys> {

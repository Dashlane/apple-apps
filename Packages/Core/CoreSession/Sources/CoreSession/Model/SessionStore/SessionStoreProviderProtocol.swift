...
public protocol SessionStoreProviderProtocol {
    ...
    associatedtype KeysStore: SessionStoreItem where KeysStore.Item == SessionSecureKeys
        ...
        func encryptedLocalKeyStore(for login: Login, info: SessionInfo, directory: SessionDirectory) throws -> LocalKeyStore
        func keysStore(for login: Login, directory: SessionDirectory, using engineSet: StoreCryptoEngineSet, info: SessionInfo) throws -> KeysStore
}

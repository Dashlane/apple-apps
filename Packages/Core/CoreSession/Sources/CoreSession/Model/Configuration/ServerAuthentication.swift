...
public enum ServerAuthentication: Equatable, Codable, Sendable, Hashable {
  case uki(UKI)
  ...
  public init(deviceAccessKey: String, deviceSecretKey: String) {
    self = .signatureBased(
      SignedAuthentication(deviceAccessKey: deviceAccessKey, deviceSecretKey: deviceSecretKey))
  }
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let authentication = try? container.decode(SignedAuthentication.self) {
      ...
      throw DecodingError.dataCorruptedError(
        in: container, debugDescription: "Cannot decode SignedAuthentication or UKI")
    }
  }
...
public struct UKI: Codable, Equatable, Sendable, Hashable {
...
public struct SignedAuthentication: Codable, Equatable, Sendable, Hashable {

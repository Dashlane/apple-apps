...
public class LocalSettingsStoreMock: LocalSettingsStore {
  ...
  public func set<T>(value: T?, forIdentifier identifier: LocalSettingsStore.Identifier)
  where T: DataConvertible {
    data[identifier] = value
  }

  public func value<T>(for identifier: LocalSettingsStore.Identifier) -> T?
  where T: DataConvertible {
...
extension LocalSettingsStore where Self == LocalSettingsStoreMock {
  public static func mock(data: [String: Any] = [:]) -> LocalSettingsStore {

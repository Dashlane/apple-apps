...
public class AppSettings {
        ...
        case safariWebCardActivated = "safariWebCardActivated"
    ...
    @SharedUserDefault(key: Key.safariWebCardActivated)
    public var safariWebCardActivated: Bool?

...
public struct LocalSettingsFactoryMock: LocalSettingsFactory {
    ...
    public func fetchOrCreateSettings(for login: DashTypes.Login, cryptoEngine: DashTypes.CryptoEngine) throws -> LocalSettingsStore {
        store
    }
...
public extension LocalSettingsFactoryMock {
	static var mock: LocalSettingsFactory {

...
struct DataLeakHiddenPopupAlertBuilder: PopupAlertBuilderProtocol {
    ...
    func build() throws -> DataLeakHiddenPopupAlert {
        ...
        return DataLeakHiddenPopupAlert(title: title,
...
extension DataLeakHiddenPopupAlertBuilder {
    func generateDescription(for alertData: AlertGenerator.AlertData, and localizationProvider: LocalizationProvider) throws -> AlertSection? {
        ...
        return AlertSection(title: AlertSection.Title(localizationProvider.localizedString(for: .popupDataLeakHiddenDescription)),
                            contents: [breachDate])
    }
}
...
extension DataLeakHiddenPopupAlertBuilder {
    func generateExplanations(for alertData: AlertGenerator.AlertData, and localizationProvider: LocalizationProvider) throws -> AlertSection? {
        ...
        return AlertSection(title: AlertSection.Title(localizationProvider.localizedString(for: .popupExplanationDataLeakTitle)),

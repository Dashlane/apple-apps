...
struct DataLeakPlaintextPopupAlertBuilder: PopupAlertBuilderProtocol {
  ...
  func build() throws -> DataLeakPlaintextPopupAlert {
    ...
    return DataLeakPlaintextPopupAlert(
      title: title,
      description: nil,
      details: details,
...
extension DataLeakPlaintextPopupAlertBuilder {
  ...
  func generateDetails(
    ...
    let affectedPasswords: String? = {
      ...
      return String(
        format: localizationProvider.localizedString(for: .popupAffectedPasswords),
...
extension DataLeakPlaintextPopupAlertBuilder {
  ...
  func generateRecommendation(
    ...
    let recommendation = String(
      format: localizationProvider.localizedString(
        for: .popupAffectedPasswordsMatchingCredentialsRecommandation), parameter)
  ...
  func noCredentialImpactedRecommendation(
    ...
    let recommendation = String(
      format: localizationProvider.localizedString(
        for: .popupRecommendationDataLeakNoDomainNoPassword), parameter)
    return AlertSection(title: .init(recommendation), contents: ["\(parameter)"])
  }
}

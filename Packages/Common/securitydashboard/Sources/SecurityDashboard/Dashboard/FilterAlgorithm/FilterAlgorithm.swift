...
protocol FilterAlgorithm {
  static func compute(
    _ credentials: [SecurityDashboardCredential], using services: PasswordHealthAnalyzerServices
  ) async -> PasswordHealthResult
}

extension FilterAlgorithm {
  static func filter(
    for credentials: [SecurityDashboardCredential], bySpaceId spaceId: String?, sensitiveOnly: Bool

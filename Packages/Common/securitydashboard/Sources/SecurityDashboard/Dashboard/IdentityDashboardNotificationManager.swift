...
public struct IdentityDashboardNotificationManager {
    ...
    public func addObserver(observer: Any, selector: Selector, notification: NotificationType, object: Any? = nil) {
        notificationCenter.addObserver(observer, selector: selector, name: notification.name, object: object)
    }

    public func removeObserver(observer: Any, notification: NotificationType? = nil, object: Any? = nil) {

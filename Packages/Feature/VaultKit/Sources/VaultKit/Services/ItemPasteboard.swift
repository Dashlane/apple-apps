...
public extension PasteboardServiceProtocol where Self == PasteboardService {
    static func mock(copied: @escaping (String) -> Void = { _ in }) -> PasteboardServiceProtocol {
...
public extension PasteboardService {
    static func mock() -> PasteboardService {
...
public extension ItemPasteboardProtocol {
...
public struct ItemPasteboard: ItemPasteboardProtocol {
    ...
    public func copy(_ value: String, for item: VaultItem, hasSecureAccess: Bool = false) -> AnyPublisher<Bool, Never> {
...
public struct ItemPasteboardMock: ItemPasteboardProtocol {
    ...
    public func copy(_ value: String, for item: VaultItem, hasSecureAccess: Bool) -> AnyPublisher<Bool, Never> {
        copied(value, item)
        return CurrentValueSubject<Bool, Never>(true).eraseToAnyPublisher()
    }
}

public extension ItemPasteboardProtocol where Self == ItemPasteboardMock {
    static func mock(copied: @escaping (String, VaultItem) -> Void = { _, _ in }) -> ItemPasteboardProtocol {

...
public struct DetailList<Content: View>: View {
    ...
    public init(offsetEnabled: Bool, titleHeight: Binding<CGFloat?>, @ViewBuilder content: () -> Content) {
...
public struct DetailDimension {
    ...
    public static let defaultNavigationBarHeight: CGFloat = placeholderHeight + navigationBarMinHeight + sectionMargin
}

...
public struct PickerDetailField<Value, Content>: DetailField
where Value: Hashable & Identifiable, Content: View {
...
extension PickerDetailField where Value: Defaultable {
  public init(
    title: String,
    selection: Binding<Value>,
    elements: [Value],

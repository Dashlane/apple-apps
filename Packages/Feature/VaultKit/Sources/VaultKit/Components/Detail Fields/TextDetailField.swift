...
public struct TextDetailField: DetailField {
    ...
    var textField: some View {
        DS.TextField(title, placeholder: placeholder, text: $text, actions: {
        ...
        .fiberAccessibilityHint(detailMode.isEditing ? Text(L10n.Core.detailItemViewAccessibilityEditableHint) : Text(""))
    }
}

...
public struct RateAppViewModel: HomeAnnouncementsServicesInjecting {
    ...
    func makeMailViewModel() -> MailViewModel {
        let subject = [L10n.Core.kwFeedbackEmailSubject, Application.version(), System.version].joined(separator: "-")
        return MailViewModel(subject: subject,
    ...
    func cancel() {
        ...
        userSettings[.rateAppDeclineResponseCount] = (userSettings[.rateAppDeclineResponseCount] ?? 0) + 1
    }

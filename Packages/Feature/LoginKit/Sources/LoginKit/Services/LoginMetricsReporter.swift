...
public class LoginMetricsReporter: LoginMetricsReporterProtocol {
  ...
  public func startLoginTimer(from biometryType: Biometry) {
    self.startLoginTimer(
      from: biometryType == .touchId ? AuthenticationType.touchId : AuthenticationType.faceId)
  }
...
public class FakeLoginMetricsReporter: LoginMetricsReporterProtocol {
  ...
  public func getPerformanceLogInfo(_ timer: LoginMetricsReporter.Timer) -> LoginPerformanceLogInfo?
  { return nil }

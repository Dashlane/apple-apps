...
public struct AuthenticatorPushVerificationView: View {
    ...
    public init(model: AuthenticatorPushVerificationViewModel, fallbackOptionTitle: String = L10n.Core.authenticatorPushViewSendTokenButtonTitle) {
        self.model = model
...
struct AuthenticatorPushView_Previews: PreviewProvider {
    static var previews: some View {
        AuthenticatorPushVerificationView(model: AuthenticatorPushVerificationViewModel(login: Login("_"), accountVerificationService: .mock, completion: {_ in}))
    }
}
#endif

...
public extension RemoteLoginDelegate {
    static var mock: RemoteLoginDelegate {
        return RemoteLoginDelegate(logger: LoggerMock(), cryptoProvider: FakeCryptoEngineProvider(), appAPIClient: .fake)
    }
}

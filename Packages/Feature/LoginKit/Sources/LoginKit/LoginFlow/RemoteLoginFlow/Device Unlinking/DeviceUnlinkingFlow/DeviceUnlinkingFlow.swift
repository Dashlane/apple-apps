...
public struct DeviceUnlinkingFlow: View {
    ...
    private func alert(devices: Set<DeviceListEntry>, error: Error) -> Alert {
        let message = DiagnosticMode.isEnabled ? error.localizedDescription : L10n.Core.deviceUnlinkAlertTitle
        return Alert(title: Text(L10n.Core.deviceUnlinkAlertTitle),

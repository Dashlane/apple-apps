...
struct LocalLoginUnlockView: View {
    ...
    private var unlockView: some View {
        ...
        case let .pincode(lock, biometry):
            LockPinCodeAndBiometryView(model: viewModel.makePinCodeViewModel(lock: lock, biometryType: biometry))
        case .sso:
            SSOUnlockView(login: viewModel.login, completion: viewModel.unlockWithSSO)

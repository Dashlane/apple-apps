...
struct PlanPurchaseViewModel {
  ...
  private let deeplinkingService: PremiumKitDeepLinkingServiceProtocol
  ...
  func goToVault() {
    deeplinkingService.handle(.goToVault)
  }
}

...
@MainActor public protocol OldImportViewModel {
...
extension OldImportViewModel {
  ...
  func report(
    _ importDataStatus: Definition.TransferDataStatus,
...
extension ImportFlowKind {
  ...
  var importSource: Definition.TransferDataSource {
    switch self {
    case .chrome:
      return .sourceChrome
    case .dash:

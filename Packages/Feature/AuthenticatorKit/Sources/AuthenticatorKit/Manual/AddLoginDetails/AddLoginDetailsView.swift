...
public struct AddLoginDetailsView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(spacing: 12) {
                userInput(header: L10n.Core.addLoginDetailsWebsiteOrApp,
                ...
                userInput(header: L10n.Core.addLoginDetailsEmailOrUsername,
                ...
                userInput(header: L10n.Core.addLoginDetailsSetupCode,
    ...
    private func userInput(
        ...
        DS.TextField(
            ...
            feedback: {
                if showError {
                    TextFieldTextualFeedback(L10n.Core.addLoginDetailsError)
                }
            }
        )
        .textFieldFeedbackAppearance(showError ? .error : nil)
        .focused(focused)
        .onSubmit(onSubmit)
    }

    var addButton: some View {
        RoundedButton(L10n.Core.addLoginDetailsAddCode, action: viewModel.save)

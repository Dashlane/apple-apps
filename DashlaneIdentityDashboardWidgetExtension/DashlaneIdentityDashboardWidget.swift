...
struct Provider: TimelineProvider {
    func placeholder(in context: Context) -> PasswordHealthEntry {
        PasswordHealthEntry(score: 88, credentialCount: 28, compromisedCount: 1, reusedCount: 8, weakCount: 9)
    }

    func getSnapshot(in context: Context, completion: @escaping (PasswordHealthEntry) -> ()) {
    ...
    func getTimeline(in context: Context, completion: @escaping (Timeline<PasswordHealthEntry>) -> ()) {
    ...
    func getLatestEntry() -> PasswordHealthEntry {
        ...
        return PasswordHealthEntry(score: score, credentialCount: credentialCount,

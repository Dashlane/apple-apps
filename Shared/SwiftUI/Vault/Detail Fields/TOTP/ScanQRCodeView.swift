...
struct ScanQRCodeView: View {
    ...
    var body: some View {
        VStack {
            Text(L10n.Localizable._2faSetupCta)
                .font(.title2)
                .lineLimit(2)
    ...
    private func cameraAlert() -> Alert {
        Alert(title: Text(L10n.Localizable.kwOtpSecretUpdate),
              message: Text(L10n.Localizable.kwRequiresCameraAccess),
              primaryButton: .default(Text(L10n.Localizable.kwAuthoriseCameraAccess), action: openSetting),
    ...
    private func dashlaneAlert() -> Alert {
        Alert(title: Text(""),
              message: Text(L10n.Localizable.kwOtpDashlaneSecretRead),

...
class GuidedOnboardingService {
  ...
  init(dataProvider: GuidedOnboardingDataProvider) {
    ...
    self.steps = [
      GuidedOnboardingSurveyStep(
        question: .whyDashlane,
        answers: [
          .autofill,
          .syncAcrossDevices,
          .warnMeAboutHacks,
  ...
  func selectAnswer(
    _ answer: GuidedOnboardingAnswer?, forQuestion question: GuidedOnboardingQuestion
  ) {
  ...
  func clearAnswers(of question: GuidedOnboardingQuestion) {

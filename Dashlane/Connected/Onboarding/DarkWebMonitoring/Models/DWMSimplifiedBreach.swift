...
public struct DWMSimplifiedBreach: Hashable {
    ...
    init(breachId: String, url: PersonalDataURL, leakedPassword: String?, date: Date?, email: String? = nil, otherLeakedData: [String]? = nil, status: StoredBreach.Status = .pending) {

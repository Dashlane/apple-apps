...
struct SSOEnableBiometricsOrPinView: View {
  ...
  var mainButton: some View {
    if viewModel.isBiometryAvailable {
      Button(L10n.Localizable.ssoUseBiometricsButton(Device.currentBiometryDisplayableName)) {
        viewModel.enableBiometry()
      }
    } else {
      Button(L10n.Localizable.ssoUsePinCodeButton) {
...
extension SSOEnableBiometricsOrPinView {
  ...
  var titleText: String {
    viewModel.isBiometryAvailable
      ? L10n.Localizable.ssoUseBiometricsTitle : L10n.Localizable.ssoUsePinCodeTitle
  }

  var contentText: String {
    viewModel.isBiometryAvailable
      ? L10n.Localizable.ssoUseBiometricsContent(Device.currentBiometryDisplayableName)
      : L10n.Localizable.ssoUsePinCodeContent
  }
}

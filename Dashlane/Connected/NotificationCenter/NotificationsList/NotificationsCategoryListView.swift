...
class NotificationsCategoryListViewModel {
    ...
    func sectionViewModel() -> NotificationSectionViewModel {
        return .init(notificationCenterService: notificationCenterService,
                     ...
                     isTruncated: false, authenticatorNotificationFactory: authenticatorNotificationFactory,
...
struct NotificationsCategoryListView_Previews: PreviewProvider {
    static let notification = ResetMasterPasswordNotification(state: .seen,
                                                              creationDate: Date(),
    ...
    static let dataSection: NotificationDataSection = .init(category: .gettingStarted, notifications: notifications)

    static var previews: some View {
        NotificationsCategoryListView(model: .init(section: dataSection,
                                                   notificationCenterService: NotificationCenterService.mock, authenticatorNotificationFactory: { _ in .mock},

...
extension UIAlertController {
  static func makeReactivationRequestAlert(
    forSetup setup: BiometricSetUpdatesService.Setup, lockService: LockService,
    ...
    case let .biometryAndMasterPasswordReset(masterPassword):
      return makeReenableBiometricsAndResetMasterPasswordPrompt(
        masterPassword: masterPassword, lockService: lockService,
        resetMasterPasswordService: resetMasterPasswordService)
    }
  }

  static private func makeReenableBiometricsPrompt(lockService: LockService) -> UIAlertController {
    let title = Device.localizedStringWithCurrentBiometry(
      key: "Authentication_BiometricsReactivationDialog_Title")
    let message = Device.localizedStringWithCurrentBiometry(
      key: "Authentication_BiometricsReactivationDialog_Description")
    let reenableTitle = NSLocalizedString(
      "Authentication_BiometricsReactivationDialog_CTA", comment: "")
    let disableActionTitle = NSLocalizedString(
      "Authentication_BiometricsReactivationDialog_Cancel", comment: "")
  ...
  static private func makeReenableBiometricsAndResetMasterPasswordPrompt(
    masterPassword: String, lockService: LockService,
    resetMasterPasswordService: ResetMasterPasswordService
  ) -> UIAlertController {
    let title = Device.localizedStringWithCurrentBiometry(
      key: "ResetMasterPassword_ReactivationDialog_Title")
    let message = Device.localizedStringWithCurrentBiometry(
      key: "ResetMasterPassword_ReactivationDialog_Description")
    let reenableTitle = NSLocalizedString("ResetMasterPassword_ReactivationDialog_CTA", comment: "")
    let disableActionTitle = NSLocalizedString(
      "ResetMasterPassword_ReactivationDialog_Cancel", comment: "")
  ...
  static public func makeMPStoredInKeychainAlert(completion: @escaping (Bool) -> Void)
    -> UIAlertController
  {
    let message =

...
struct DarkWebMonitoringView: View {
    ...
    private var premiumBody: some View {
        DarkWebMonitoringPremiumListView(dwmService: model.darkWebMonitoringService,
    ...
    private var dwmBody: some View {
        VStack(alignment: .leading, spacing: 0) {
            DarkWebMonitoringMonitoredEmailsView(model: model.headerViewModelFactory.make(actionPublisher: model.actionPublisher))
                .layoutPriority(1)

...
@MainActor
class SharingMembersDetailLinkModel: ObservableObject, SessionServicesInjecting,
...
extension SharingMembersDetailLinkModel {
  static func mock(item: VaultItem, sharingService: SharingServiceProtocol = SharingServiceMock())

...
protocol UserSpacePopoverModelProtocol: ObservableObject {
...
struct UserSpacePopover<Model: UserSpacePopoverModelProtocol>: ViewModifier {
    ...
    func body(content: Content) -> some View {
        if model.availableSpaces.count < 2 {
            ...
            content
                .popover(isPresented: $model.isPopoverPresented,
    ...
    func selectionView() -> some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            ForEach(self.model.availableSpaces, id: \.self) { userSpace in
                VStack(alignment: .leading, spacing: 12) {
                    Button(action: {

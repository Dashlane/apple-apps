...
public class AccountRecoveryKeyStatusViewModel: ObservableObject, SessionServicesInjecting {
    ...
    private let recoveryKeyStatusDetailViewModelFactory: AccountRecoveryKeyStatusDetailViewModel.Factory
    ...
    func makeAccountRecoveryKeyStatusDetailViewModel(isEnabled: Bool) -> AccountRecoveryKeyStatusDetailViewModel {
...
extension AccountRecoveryKeyStatusViewModel {
    static var mock: AccountRecoveryKeyStatusViewModel {
        AccountRecoveryKeyStatusViewModel(session: .mock, appAPIClient: .fake, userAPIClient: .fake, reachability: NetworkReachability(isConnected: true), recoveryKeyStatusDetailViewModelFactory: AccountRecoveryKeyStatusDetailViewModel.Factory({ _ in

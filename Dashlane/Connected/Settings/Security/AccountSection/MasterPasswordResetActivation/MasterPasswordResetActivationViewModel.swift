...
final class MasterPasswordResetActivationViewModel: ObservableObject, SessionServicesInjecting {
    ...
    func handleMasterPasswordChallengeStatus(_ status: MasterPasswordChallengeAlertViewModel.Completion) {
    ...
    func handleToggleValueChange(newValue enabled: Bool) {
        guard enabled && !resetMasterPasswordService.isActive || !enabled && resetMasterPasswordService.isActive
        else { return }

...
struct NotificationSubscription<Notification: NotificationInfoContainer, Output>: Hashable {
    static func == (lhs: NotificationSubscription<Notification, Output>, rhs: NotificationSubscription<Notification, Output>) -> Bool {
...
extension Collection {
    func first<N: NotificationInfoContainer, Output>(for notification: N) -> Element?  where Element == NotificationSubscription<N, Output> {
        return self.first {

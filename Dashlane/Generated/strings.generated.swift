...
internal enum L10n {
  ...
  internal enum Localizable {
    ...
    internal static let _2faSetupFailureGeneric = L10n.tr(
      "Localizable", "2faSetup_failure_generic", fallback: "We couldn’t set up 2FA")
    ...
    internal static let accessibilityCollapse = L10n.tr(
      "Localizable", "accessibilityCollapse", fallback: "Collapse")
    internal static let accessibilityCollapsed = L10n.tr(
      "Localizable", "accessibilityCollapsed", fallback: "Collapsed")
    internal static let accessibilityExpand = L10n.tr(
      "Localizable", "accessibilityExpand", fallback: "Expand")
    internal static let accessibilityExpanded = L10n.tr(
      "Localizable", "accessibilityExpanded", fallback: "Expanded")
    ...
    internal static let accountSummaryAccountVerification = L10n.tr(
      "Localizable", "accountSummary_accountVerification", fallback: "Account verification")
    internal static let accountSummaryContactEmail = L10n.tr(
      "Localizable", "accountSummary_contactEmail", fallback: "Contact email")
    internal static let accountSummaryEdit = L10n.tr(
      "Localizable", "accountSummary_edit", fallback: "Edit")
    internal static let accountSummaryLogin = L10n.tr(
      "Localizable", "accountSummary_login", fallback: "Login")
    internal static let accountSummaryLoginEmail = L10n.tr(
      "Localizable", "accountSummary_loginEmail", fallback: "Login email")
    internal static let accountSummaryTitle = L10n.tr(
      "Localizable", "accountSummary_title", fallback: "Account summary")
    internal static let accountSummaryVerificationCodesSent = L10n.tr(
      "Localizable", "accountSummary_verificationCodesSent",
      fallback: "Verification codes will be sent to this email address to verify your identity.")
    internal static let accountSummaryYourLoginEmailCantBeChanged = L10n.tr(
      "Localizable", "accountSummary_yourLoginEmailCantBeChanged",
      fallback: "Your login email cannot be changed. Learn more by visiting our Help Center.")
    ...
    internal static let actionItemSecureLockDetailOpticid = L10n.tr(
      "Localizable", "ACTION_ITEM_SECURE_LOCK_DETAIL_OPTICID",
      fallback: "Access your account the safe and simple way by using Optic ID.")
    internal static let actionItemSecureLockDetailPin = L10n.tr(
      "Localizable", "ACTION_ITEM_SECURE_LOCK_DETAIL_PIN",
      fallback: "Access your account the safe and simple way by using PIN.")
    ...
    internal static let actionItemsCenterTitle = L10n.tr(
      "Localizable", "ACTION_ITEMS_CENTER_TITLE", fallback: "Notifications")
    ...
    internal static let announcePinCta = L10n.tr(
      "Localizable", "ANNOUNCE_PIN_CTA", fallback: "Set up secure PIN unlock")
    ...
    internal static let authenticatorToolOnboardingActionItemDescriptionAccessibility = L10n.tr(
      "Localizable", "authenticatorToolOnboardingActionItemDescriptionAccessibility",
      fallback:
        "Use Dashlane’s Authenticator tool to add an extra layer of security to your accounts with 2-factor authentication (2 F A)."
    )
    ...
    internal static let changeMpInfoLabel = L10n.tr(
      "Localizable", "CHANGE_MP_INFO_LABEL",
      fallback:
        "If you have an account recovery key enabled, it will be turned off as a result of this change. To generate a new recovery key, turn this on again in your security settings."
    )
    internal static let changeContactEmailCancel = L10n.tr(
      "Localizable", "changeContactEmail_cancel", fallback: "Cancel")
    internal static let changeContactEmailCurrentContactEmail = L10n.tr(
      "Localizable", "changeContactEmail_currentContactEmail", fallback: "Current contact email")
    internal static let changeContactEmailErrorToast = L10n.tr(
      "Localizable", "changeContactEmail_error_toast", fallback: "Failed to change contact email")
    internal static let changeContactEmailFooter = L10n.tr(
      "Localizable", "changeContactEmail_footer",
      fallback:
        "This email address will be used to verify your identity when you change your Master Password or add a new device."
    )
    internal static let changeContactEmailNewContactEmail = L10n.tr(
      "Localizable", "changeContactEmail_newContactEmail", fallback: "New contact email")
    internal static let changeContactEmailPrompt = L10n.tr(
      "Localizable", "changeContactEmail_prompt", fallback: "Change contact email")
    internal static let changeContactEmailSave = L10n.tr(
      "Localizable", "changeContactEmail_save", fallback: "Save")
    ...
    internal static let credentialProviderListTitleOtps = L10n.tr(
      "Localizable", "CredentialProvider_ListTitle_otps", fallback: "Dashlane OTPs")
    internal static let credentialProviderListTitlePasskeys = L10n.tr(
      "Localizable", "CredentialProvider_ListTitle_passkeys", fallback: "Dashlane Passkeys")
    internal static let credentialProviderListTitlePasswords = L10n.tr(
      "Localizable", "CredentialProvider_ListTitle_passwords", fallback: "Dashlane Passwords")
    ...
    internal static let credentialProviderOnboardingActivatedBody = L10n.tr(
      ...
      fallback: "To make Dashlane your default password manager, turn off Keychain.")
    internal static let credentialProviderOnboardingActivatedTitle = L10n.tr(
      "Localizable", "CredentialProviderOnboarding_ActivatedTitle", fallback: "Turn off Keychain")
    ...
    internal static let credentialProviderOnboardingPasswordsAppActivatedBody = L10n.tr(
      "Localizable", "CredentialProviderOnboarding_PasswordsAppActivatedBody",
      fallback: "To make Dashlane your default password manager, turn off the Apple Passwords app.")
    internal static let credentialProviderOnboardingPasswordsAppName = L10n.tr(
      "Localizable", "CredentialProviderOnboarding_PasswordsAppName", fallback: "Passwords")
    internal static let cryptoDescriptionForBusinessAdmins = L10n.tr(
      "Localizable", "cryptoDescriptionForBusinessAdmins",
      fallback:
        "Go to your security settings in the Dashlane team admin console to edit the key derivation function."
    )
    internal static let cryptoDescriptionForBusinessUsers = L10n.tr(
      "Localizable", "cryptoDescriptionForBusinessUsers",
      fallback:
        "Dashlane encrypts data using AES-256 and a key derivation function (KDF). Your plan admin has chosen the KDF for your organization."
    )
    ...
    internal static let dashExportCta = L10n.tr(
      "Localizable", "Dash_export_cta", fallback: "Export")
    internal static let dashExportDescription = L10n.tr(
      "Localizable", "Dash_export_description",
      fallback:
        "This password should be different from the Master Password for your Dashlane account. If you forgot the password for your DASH file, you won't be able to import the file to Dashlane."
    )
    internal static let dashExportPlaceholder = L10n.tr(
      "Localizable", "Dash_export_placeholder", fallback: "Password")
    internal static let dashExportProgressLabel = L10n.tr(
      "Localizable", "Dash_export_progress_label", fallback: "Exporting Secure Archive…")
    internal static let dashExportSubtitle = L10n.tr(
      "Localizable", "Dash_export_subtitle",
      fallback: "Create a password to lock your encrypted DASH file")
    internal static let dashExportTitle = L10n.tr(
      "Localizable", "Dash_export_title", fallback: "Enter a password")
    ...
    internal static func dataleakEmailStopMonitoring(_ p1: Any) -> String {
      return L10n.tr(
        "Localizable", "DATALEAK_EMAIL_STOP_MONITORING", String(describing: p1), fallback: "_")
    }
    ...
    internal static let dpsBeforeContinuing = L10n.tr(
      "Localizable", "dps_beforeContinuing",
      fallback:
        "Before continuing, move any personal items stored in your Business Space to your Personal Space."
    )
    internal static let dpsCancel = L10n.tr("Localizable", "dps_cancel", fallback: "Cancel")
    internal static let dpsExportOnlyYourPersonalData = L10n.tr(
      "Localizable", "dps_exportOnlyYourPersonalData", fallback: "Export only your personal data")
    internal static let dpsExportRestrictedAction = L10n.tr(
      "Localizable", "dps_exportRestricted_action", fallback: "Close")
    internal static let dpsExportRestrictedAlertMessage = L10n.tr(
      "Localizable", "dps_exportRestricted_alertMessage",
      fallback:
        "Exporting items stored in Dashlane is restricted, contact your Admin for more information."
    )
    internal static let dpsExportRestrictedAlertTitle = L10n.tr(
      "Localizable", "dps_exportRestricted_alertTitle",
      fallback: "Your company policy restricts data export")
    internal static let dpsYourCompanyPolicyPreventsExporting = L10n.tr(
      "Localizable", "dps_yourCompanyPolicyPreventsExporting",
      fallback:
        "Your company policy prevents you from exporting items stored in your Business Space.")
    ...
    internal static let enterPasscode = L10n.tr(
      "Localizable", "EnterPasscode", fallback: "Enter PIN")
    ...
    internal static let export = L10n.tr("Localizable", "export", fallback: "Export")
    internal static let exportDataHeader = L10n.tr(
      "Localizable", "export_data_header", fallback: "Backup or transfer your data")
    internal static let exportDataLabel = L10n.tr(
      "Localizable", "export_data_label", fallback: "Backup or transfer your data")
    internal static let exportDataToAppLabel = L10n.tr(
      "Localizable", "export_data_to_app_label", fallback: "Export data to another app")
    ...
    internal static let fastLocalSetupMasterPasswordReset = L10n.tr(
      "Localizable", "FastLocalSetup_MasterPasswordReset", fallback: "Biometric recovery")
    ...
    internal static let fastLocalSetupOpticIDDescription = L10n.tr(
      "Localizable", "FastLocalSetup_OpticID_Description",
      fallback: "Unlock Dashlane with just a glance.")
    ...
    internal static let importButtonCancel = L10n.tr(
      "Localizable", "import_button_cancel", fallback: "Cancel")
    internal static let importSourceAnotherManager = L10n.tr(
      "Localizable", "import_source_another_manager", fallback: "from another password manager")
    internal static let importSourceDashlaneBackupSubtitle = L10n.tr(
      "Localizable", "import_source_dashlane_backup_subtitle", fallback: "Import your DASH file")
    internal static let importSourceDashlaneBackupTitle = L10n.tr(
      "Localizable", "import_source_dashlane_backup_title", fallback: "Dashlane backup")
    internal static let importSourceDataTitle = L10n.tr(
      "Localizable", "import_source_data_title", fallback: "Where are you importing data from?")
    internal static let importSourceManuallyTitle = L10n.tr(
      "Localizable", "import_source_manually_title", fallback: "Add logins manually")
    internal static let importSourceOther = L10n.tr(
      "Localizable", "import_source_other", fallback: "other")
    internal static let importSourceOtherManagersSubtitle = L10n.tr(
      "Localizable", "import_source_other_managers_subtitle", fallback: "Import manually")
    internal static let importSourceOtherManagersTitle = L10n.tr(
      "Localizable", "import_source_other_managers_title", fallback: "Other password managers")
    ...
    internal static let itemsTabSearchPlaceholder = L10n.tr(
      "Localizable", "ITEMS_TAB_SEARCH_PLACEHOLDER", fallback: "Search in your vault")
    ...
    internal static let kwChangePinCode = L10n.tr(
      "Localizable", "KW_CHANGE_PIN_CODE", fallback: "Change PIN")
    internal static let kwChoosePinCode = L10n.tr(
      "Localizable", "KW_CHOOSE_PIN_CODE", fallback: "Choose a PIN")
    ...
    internal static let kwConfirmPinCode = L10n.tr(
      "Localizable", "KW_CONFIRM_PIN_CODE", fallback: "Confirm your PIN")
    ...
    internal static let kwEnterYourPinCode = L10n.tr(
      "Localizable", "KW_ENTER_YOUR_PIN_CODE", fallback: "Unlock with your PIN")
    ...
    internal static let kwKeychainPasswordMsgPinOnly = L10n.tr(
      ...
      fallback: "When using a PIN, your Master Password is securely memorized on this device")
    ...
    internal static let kwSettingsPinTypeFooter = L10n.tr(
      ...
      fallback:
        "Unlock Dashlane with a PIN. We'll occasionally ask you to log in with your Master Password for security reasons."
    )
    ...
    internal static let kwShareSecurenote = L10n.tr(
      "Localizable", "KW_SHARE_SECURENOTE", fallback: "Share secure note")
    ...
    internal static let kwSharingCenterSectionCollections = L10n.tr(
      "Localizable", "KW_SHARING_CENTER_SECTION_COLLECTIONS", fallback: "Collections")
    ...
    internal static let kwSharingCenterSectionUsersAndGroups = L10n.tr(
      "Localizable", "KW_SHARING_CENTER_SECTION_USERS_AND_GROUPS", fallback: "Users & Groups")
    ...
    internal static func kwSharingCollectionsPlural(_ p1: Int) -> String {
      return L10n.tr(
        "Localizable", "KW_SHARING_COLLECTIONS_PLURAL", p1, fallback: "%1$d collections")
    }
    internal static func kwSharingCollectionsSingular(_ p1: Int) -> String {
      return L10n.tr(
        "Localizable", "KW_SHARING_COLLECTIONS_SINGULAR", p1, fallback: "%1$d collection")
    }
    ...
    internal static let kwUsePinCode = L10n.tr(
      "Localizable", "KW_USE_PIN_CODE", fallback: "Use PIN")
    ...
    internal static let kwWrongPinCode = L10n.tr(
      "Localizable", "KW_WRONG_PIN_CODE", fallback: "Wrong PIN")
    internal static let kwWrongPinCodeMessage = L10n.tr(
      "Localizable", "KW_WRONG_PIN_CODE_MESSAGE", fallback: "The PIN you entered is incorrect.")
    ...
    internal static let mplessLogoutAlertMessage = L10n.tr(
      "Localizable", "MPLESS_LOGOUT_ALERT_MESSAGE",
      fallback:
        "If you don’t have another logged in device or your recovery key, you could lose access to your account."
    )
    internal static let mplessLogoutAlertTitle = L10n.tr(
      "Localizable", "MPLESS_LOGOUT_ALERT_TITLE", fallback: "Are you sure you want to log out?")
    internal static func mplessPinBiometryLockSettingsFooter(_ p1: Any) -> String {
      return L10n.tr(
        "Localizable", "MPLESS_PIN_BIOMETRY_LOCK_SETTINGS_FOOTER", String(describing: p1),
        fallback: "_")
    }
    internal static let mplessPinLockSettingsFooter = L10n.tr(
      "Localizable", "MPLESS_PIN_LOCK_SETTINGS_FOOTER",
      fallback: "Unlock Dashlane with your device-specific PIN.")
    internal static let mplessRecoveryIntroMessage = L10n.tr(
      "Localizable", "MPLESS_RECOVERY_INTRO_MESSAGE",
      fallback:
        "This is a spare key to your vault. If you lose your device or forget your PIN, you can use it to access your account."
    )
    internal static let mplessRecoverySkipAlertCta = L10n.tr(
      "Localizable", "MPLESS_RECOVERY_SKIP_ALERT_CTA", fallback: "Yes, skip")
    internal static let mplessRecoverySkipAlertMessage = L10n.tr(
      "Localizable", "MPLESS_RECOVERY_SKIP_ALERT_MESSAGE",
      fallback:
        "If you lose your device or forget your PIN, this key is the only way you can access your account."
    )
    internal static let mplessRecoverySkipAlertTitle = L10n.tr(
      "Localizable", "MPLESS_RECOVERY_SKIP_ALERT_TITLE", fallback: "Skip recovery key set up?")
    internal static let mplessRecoverySkipCta = L10n.tr(
      "Localizable", "MPLESS_RECOVERY_SKIP_CTA", fallback: "Skip for now")
    ...
    internal static let otpToolFaqHelpDescription = L10n.tr(
      ...
      fallback: "If you need more help, visit our Help Center.")
    ...
    internal static func passwordHealthDetailedCompromisedListHeadlinePlural(_ p1: Int) -> String {
      return L10n.tr(
        "Localizable", "passwordHealthDetailedCompromisedListHeadlinePlural", p1,
        fallback: "You have %1$d compromised passwords that need to be replaced.")
    }
    internal static let passwordHealthDetailedCompromisedListHeadlineSingular = L10n.tr(
      "Localizable", "passwordHealthDetailedCompromisedListHeadlineSingular",
      fallback: "You have 1 compromised password that needs to be replaced.")
    ...
    internal static func passwordHealthDetailedReusedListHeadlinePlural(_ p1: Int) -> String {
      return L10n.tr(
        "Localizable", "passwordHealthDetailedReusedListHeadlinePlural", p1,
        fallback: "You have %1$d reused passwords that need to be replaced.")
    }
    internal static let passwordHealthDetailedReusedListHeadlineSingular = L10n.tr(
      "Localizable", "passwordHealthDetailedReusedListHeadlineSingular",
      fallback: "You have 1 reused password that needs to be replaced.")
    internal static func passwordHealthDetailedWeakListHeadlinePlural(_ p1: Int) -> String {
      return L10n.tr(
        "Localizable", "passwordHealthDetailedWeakListHeadlinePlural", p1,
        fallback: "You have %1$d weak passwords that need to be replaced.")
    }
    internal static let passwordHealthDetailedWeakListHeadlineSingular = L10n.tr(
      "Localizable", "passwordHealthDetailedWeakListHeadlineSingular",
      fallback: "You have 1 weak password that needs to be replaced.")
    ...
    internal static let postLoginRecoveryKeyDisabledCancel = L10n.tr(
      "Localizable", "POST_LOGIN_RECOVERY_KEY_DISABLED_CANCEL", fallback: "Dismiss")
    internal static let postLoginRecoveryKeyDisabledCta = L10n.tr(
      "Localizable", "POST_LOGIN_RECOVERY_KEY_DISABLED_CTA", fallback: "Go to settings")
    internal static let postLoginRecoveryKeyDisabledMessage = L10n.tr(
      "Localizable", "POST_LOGIN_RECOVERY_KEY_DISABLED_MESSAGE",
      fallback: "To generate a new recovery key, turn this on again in your security settings.")
    internal static let postLoginRecoveryKeyDisabledMpMessage = L10n.tr(
      "Localizable", "POST_LOGIN_RECOVERY_KEY_DISABLED_MP_MESSAGE",
      fallback:
        "For your security, we turned this off when your Master Password changed. This means your existing recovery key is no longer valid."
    )
    internal static let postLoginRecoveryKeyDisabledMplessMessage = L10n.tr(
      "Localizable", "POST_LOGIN_RECOVERY_KEY_DISABLED_MPLESS_MESSAGE",
      fallback: "For your security, we turned this off when you used your recovery key.")
    internal static let postLoginRecoveryKeyDisabledTitle = L10n.tr(
      "Localizable", "POST_LOGIN_RECOVERY_KEY_DISABLED_TITLE",
      fallback: "Your recovery key setting was turned off")
    ...
    internal static let recoveryKeySettingsFooterMpless = L10n.tr(
      "Localizable", "RECOVERY_KEY_SETTINGS_FOOTER_MPLESS",
      fallback:
        "Your recovery key lets you access your vault if you have lost access to all other logged in devices."
    )
    ...
    internal static let resetMasterPasswordNotificationCenterItemTitle = L10n.tr(
      ...
      fallback: "Turn on biometric recovery")
    ...
    internal static let resetMasterPasswordReactivationDialogTitle = L10n.tr(
      ...
      fallback: "Turn Face ID and biometric recovery back on?")
    ...
    internal static let resetMasterPasswordResetSuggestedDialogTitle = L10n.tr(
      ...
      fallback: "Also turn on biometric recovery?")
    ...
    internal static let resetMasterPasswordSettingsItemTitle = L10n.tr(
      "Localizable", "ResetMasterPassword_Settings_Item_Title", fallback: "Biometric recovery")
    ...
    internal static let secretLockedNotice = L10n.tr(
      "Localizable", "secretLockedNotice", fallback: "Secret locked")
    internal static let secretUnlockedNotice = L10n.tr(
      "Localizable", "secretUnlockedNotice", fallback: "Secret unlocked")
    internal static func sectionItem(_ p1: Int) -> String {
      return L10n.tr("Localizable", "sectionItem", p1, fallback: "%1$d item")
    }
    internal static func sectionItems(_ p1: Int) -> String {
      return L10n.tr("Localizable", "sectionItems", p1, fallback: "%1$d items")
    }
    internal static let secureNoteDetails = L10n.tr(
      "Localizable", "secureNoteDetails", fallback: "Secure note details")
    ...
    internal static func sharingItemSelected(_ p1: Int) -> String {
      return L10n.tr(
        "Localizable", "sharing_itemSelected", p1, fallback: "Next, %1$d item selected")
    }
    internal static func sharingItemsSelected(_ p1: Int) -> String {
      return L10n.tr(
        "Localizable", "sharing_itemsSelected", p1, fallback: "Next, %1$d items selected")
    }
    internal static func sharingRecipientSelected(_ p1: Int) -> String {
      return L10n.tr(
        "Localizable", "sharing_recipientSelected", p1, fallback: "Next, %1$d recipient selected")
    }
    internal static func sharingRecipientsSelected(_ p1: Int) -> String {
      return L10n.tr(
        "Localizable", "sharing_recipientsSelected", p1, fallback: "Next, %1$d recipients selected")
    }
    ...
    internal static let ssoUsePinCodeButton = L10n.tr(
      "Localizable", "ssoUsePinCodeButton", fallback: "Enter a PIN")
    internal static let ssoUsePinCodeContent = L10n.tr(
      "Localizable", "ssoUsePinCodeContent",
      fallback:
        "Breeze through logins! Use your PIN to log in to Dashlane quickly and securely on this device."
    )
    internal static let ssoUsePinCodeTitle = L10n.tr(
      "Localizable", "ssoUsePinCodeTitle", fallback: "Unlock Dashlane with your PIN")
    ...
    internal static let tachyonAuthenticationScreenUsePinCode = L10n.tr(
      "Localizable", "TachyonAuthenticationScreenUsePinCode", fallback: "Use PIN")
    ...
    internal static let vpnActivationViewErrorContactSupport = L10n.tr(
      "Localizable", "vpnActivationView_error_contactSupport", fallback: "Visit our Help Center.")
    ...
    internal enum AccountCreation {
      internal enum Finish {
        internal static let createButton = L10n.tr(
          "Localizable", "AccountCreation.Finish.createButton", fallback: "Create your account")
      }
    }
    ...
    internal enum Mpless {
      internal enum D2d {
        internal static let trustedIntroMessage1 = L10n.tr(
          "Localizable", "Mpless.d2d.trusted_intro_message1",
          fallback: "Open Dashlane on your new device and enter your email")
        internal static let trustedIntroMessage2 = L10n.tr(
          "Localizable", "Mpless.d2d.trusted_intro_message2",
          fallback:
            "**If QR code login:** Return here to scan it \n**If Security Challenge login:** \n Return here to validate request and complete the challenge"
        )
        internal static let trustedIntroMessage3 = L10n.tr(
          "Localizable", "Mpless.d2d.trusted_intro_message3",
          fallback: "Log in to Dashlane on your new device")
        internal static let trustedIntroTitle = L10n.tr(
          "Localizable", "Mpless.d2d.trusted_intro_title",
          fallback: "Log in on your new device with a QR code or security challenge")
        internal static let trustedNavigationTitle = L10n.tr(
          "Localizable", "Mpless.d2d.trusted_navigation_title", fallback: "Add new device")
        internal enum Trusted {
          internal static let limitErrorCta = L10n.tr(
            "Localizable", "Mpless.d2d.trusted.limit_error_cta", fallback: "Back to settings")
          internal static let limitErrorMessage = L10n.tr(
            "Localizable", "Mpless.d2d.trusted.limit_error_message",
            fallback:
              "You have reached the limit of allowable attempts. You will have to restart login attempt from new device."
          )
          internal static let limitErrorTitle = L10n.tr(
            "Localizable", "Mpless.d2d.trusted.limit_error_title", fallback: "Exceeded attempts")
          internal static let timeoutErrorCta = L10n.tr(
            "Localizable", "Mpless.d2d.trusted.timeout_error_cta", fallback: "Back to settings")
          internal static let timeoutErrorMessage = L10n.tr(
            "Localizable", "Mpless.d2d.trusted.timeout_error_message",
            fallback: "Please attempt to log in again from new device.")
          internal static let timeoutErrorTitle = L10n.tr(
            "Localizable", "Mpless.d2d.trusted.timeout_error_title",
            fallback: "New device request has timed out")
        }
        internal enum Universal {
          internal static let pendingTransferInfoboxTitle = L10n.tr(
            "Localizable", "Mpless.d2d.universal.pending_transfer_infobox_title",
            fallback:
              "Do the above details match your device? Dashlane will never ask you to add a device. Always start this directly through the Dashlane mobile app or the browser extension."
          )
          internal static let pendingTransferMessage = L10n.tr(
            "Localizable", "Mpless.d2d.universal.pending_transfer_message",
            fallback: "The request to add a new device was made from:")
          internal static let pendingTransferPrimaryCta = L10n.tr(
            "Localizable", "Mpless.d2d.universal.pending_transfer_primary_cta",
            fallback: "Yes, it's me")
          internal static let pendingTransferSecondaryCta = L10n.tr(
            "Localizable", "Mpless.d2d.universal.pending_transfer_secondary_cta",
            fallback: "No, it's not me")
          internal static let pendingTransferTitle = L10n.tr(
            "Localizable", "Mpless.d2d.universal.pending_transfer_title",
            fallback: "A new device request has been detected")
          internal static let refreshCta = L10n.tr(
            "Localizable", "Mpless.d2d.universal.refresh_cta", fallback: "Refresh request")
          internal enum Trusted {
            internal static let completedChallenge = L10n.tr(
              "Localizable", "Mpless.d2d.universal.trusted.completed_challenge",
              fallback: "Successfully completed security challenge!")
            internal static let loadingChallenge = L10n.tr(
              "Localizable", "Mpless.d2d.universal.trusted.loading_challenge",
              fallback: "Loading challenge...")
            internal static let passphraseCancelCta = L10n.tr(
              "Localizable", "Mpless.d2d.universal.trusted.passphrase_cancel_cta",
              fallback: "Cancel")
            internal static let passphraseConfirmCta = L10n.tr(
              "Localizable", "Mpless.d2d.universal.trusted.passphrase_confirm_cta",
              fallback: "Confirm")
            internal static let passphraseLabel = L10n.tr(
              "Localizable", "Mpless.d2d.universal.trusted.passphrase_label",
              fallback: "Missing word")
            internal static func passphraseTitle(_ p1: Any) -> String {
              return L10n.tr(
                "Localizable", "Mpless.d2d.universal.trusted.passphrase_title",
                String(describing: p1), fallback: "_")
            }
            internal static let rejectedToast = L10n.tr(
              "Localizable", "Mpless.d2d.universal.trusted.rejected_toast",
    ...
    internal enum NewMasterPassword {
      internal static let skipMasterPasswordButton = L10n.tr(
        "Localizable", "NewMasterPassword.skipMasterPasswordButton",
        fallback: "Create passwordless account")
      internal static let title = L10n.tr(
        "Localizable", "NewMasterPassword.title", fallback: "...and a Master Password")
    }
    internal enum PasswordlessAccountCreation {
      internal enum Biometry {
        internal static func message(_ p1: Any) -> String {
          return L10n.tr(
            "Localizable", "PasswordlessAccountCreation.Biometry.message", String(describing: p1),
            fallback: "_")
        }
        internal static func title(_ p1: Any) -> String {
          return L10n.tr(
            "Localizable", "PasswordlessAccountCreation.Biometry.title", String(describing: p1),
            fallback: "_")
        }
        internal static func useButton(_ p1: Any) -> String {
          return L10n.tr(
            "Localizable", "PasswordlessAccountCreation.Biometry.useButton", String(describing: p1),
            fallback: "_")
        }
      }
      internal enum Complete {
        internal static let title = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Complete.title",
          fallback: "Your Dashlane account is ready to go! ")
      }
      internal enum Finish {
        internal static let message = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Finish.message",
          fallback:
            "Agree to Dashlane’s Terms of Service and Privacy Policy to create your account.")
        internal static let title = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Finish.title",
          fallback: "Finish creating your account")
      }
      internal enum Intro {
        internal static let getStartedButton = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Intro.getStartedButton",
          fallback: "Get started")
        internal static let infoBox = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Intro.infoBox",
          fallback:
            "Passwordless authentication is only available on mobile devices and Dashlane's Safari app."
        )
        internal static let learnMoreButton = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Intro.learnMoreButton", fallback: "Learn more"
        )
        internal static let message = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Intro.message",
          fallback:
            "Go passwordless and use a device-specific PIN to log in instead of a Master Password.")
        internal static let message1 = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Intro.message1",
          fallback: "Set a device specific **PIN** and **biometrics** to log in to this device")
        internal static let message2 = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Intro.message2",
          fallback: "Get a **recovery key** you can use in the event you lose your device(s)")
        internal static let message3 = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Intro.message3",
          fallback:
            "Use this device to log in to new devices using **QR code** or **security challenge**")
        internal static let navigationTitle = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Intro.navigationTitle",
          fallback: "Passwordless authentication")
        internal static let title = L10n.tr(
          "Localizable", "PasswordlessAccountCreation.Intro.title",
          fallback: "Create an account without a Master Password")
      }
    }
    ...
    internal enum Settings {
      ...
      internal enum Export {
        internal static let exportButton = L10n.tr(
          "Localizable", "settings.export.exportButton", fallback: "Export data")
        internal enum Csv {
          internal static let exportButton = L10n.tr(
            "Localizable", "settings.export.csv.exportButton", fallback: "Export data to CSV")
          internal static let footer = L10n.tr(
            "Localizable", "settings.export.csv.footer",
            fallback: "Backup your Dashlane data to a readable format.")
          internal enum ExportView {
            internal static let description = L10n.tr(
              "Localizable", "settings.export.csv.exportView.description",
              fallback:
                "CSV files aren't encrypted, and others can read them. Delete the CSV file from your device after you're done using it."
            )
            internal static let errorTitle = L10n.tr(
              "Localizable", "settings.export.csv.exportView.errorTitle", fallback: "Export failed")
            internal static let exportButton = L10n.tr(
              "Localizable", "settings.export.csv.exportView.exportButton",
              fallback: "Export to CSV")
            internal static let helpLink = L10n.tr(
              "Localizable", "settings.export.csv.exportView.helpLink",
              fallback: "Learn more on how to export")
            internal static let successToast = L10n.tr(
              "Localizable", "settings.export.csv.exportView.successToast",
              fallback: "File exported")
            internal static let title = L10n.tr(
              "Localizable", "settings.export.csv.exportView.title",
              fallback: "Move your Dashlane data using a CSV file")
          }
        }
        internal enum DashArchive {
          internal static let exportButton = L10n.tr(
            "Localizable", "settings.export.dashArchive.exportButton",
            fallback: "Export data to DASH file")
          internal static let footer = L10n.tr(
            "Localizable", "settings.export.dashArchive.footer",
            fallback: "Backup your Dashlane data to an encrypted DASH file.")
        }
      }
      internal enum Security {
        internal static let richIconsDescription = L10n.tr(
          "Localizable", "settings.security.richIconsDescription",
          fallback: "Dashlane will download and display rich icons on your logins and contacts.")
        internal static let richIconsToggle = L10n.tr(
          "Localizable", "settings.security.richIconsToggle", fallback: "Show rich icons")
      }
    }
  }
}
